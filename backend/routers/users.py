...
async def login(form_data: OAuth2PasswordRequestForm = Depends()):
    ...
    # 3. Create JWT token
    # NOTE: Never put password inside JWT 
    ...
    # 4. Return token — frontend stores this in localStorage
    return {
...
# (localStorage.removeItem). We just log it here.
# ---------------------------------------------------------------
